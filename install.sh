...
wget -O /etc/nginx/sites-enabled/default.conf https://raw.githubusercontent.com/sanasol/highload-lemp/master/default.conf
# Create fastcgi.conf
...
# Create nginx.conf
wget -O /etc/nginx/nginx.conf https://raw.githubusercontent.com/sanasol/highload-lemp/master/nginx.conf
...
sed -i "s/^-l 127.3.0.1/#-l 127.3.0.1/" /etc/memcached.conf
